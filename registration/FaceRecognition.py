...
def faceDetection(test_img):
    ...
    face_haar_cascade = cv2.CascadeClassifier('media/cascades/data/haarcascade_frontalface_alt2.xml')  # Load haar classifier
...
def labels_for_training_data(directory):
    ...
    for path, subdirnames, filenames in os.walk(directory):
        for filename in filenames:
            ...
            ids = os.path.basename(path)  # fetching subdirectory names
